    ...
    if area == "NO":
        ...
        if r.status_code == 200:
            ...
            if "晴" in res['data']['tq']:
                ...
                K = K_dict["多云"]
            elif "阴" in res['data']['tq']:
                K = K_dict["阴"]
            elif "小雨" in res['data']['tq']:
                K = K_dict["小雨"]
            elif "中雨" in res['data']['tq']:
                K = K_dict["中雨"]
            elif "大雨" in res['data']['tq']:
                K = K_dict["大雨"]
            elif "暴雨" in res['data']['tq']:
                K = K_dict["暴雨"]
            elif "大暴雨" in res['data']['tq']:
                K = K_dict["大暴雨"]
